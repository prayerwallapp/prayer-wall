  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        palette: {
          cornflower: "var(--color-palette-cornflower)",
          lime: "var(--color-palette-lime)",
          peach: "var(--color-palette-peach)",
          lavender: "var(--color-palette-lavender)",
          blush: "var(--color-palette-blush)",
          seafoam: "var(--color-palette-seafoam)",
          butter: "var(--color-palette-butter)",
          periwinkle: "var(--color-palette-periwinkle)",
        },
        avatar: {
          "slot-1": "var(--color-avatar-slot-1)",
          "slot-2": "var(--color-avatar-slot-2)",
          "slot-3": "var(--color-avatar-slot-3)",
          "slot-4": "var(--color-avatar-slot-4)",
          "slot-5": "var(--color-avatar-slot-5)",
          "slot-6": "var(--color-avatar-slot-6)",
          "slot-7": "var(--color-avatar-slot-7)",
          "slot-8": "var(--color-avatar-slot-8)",
        },
      },
      spacing: {
        xs: "var(--spacing-xs)",
